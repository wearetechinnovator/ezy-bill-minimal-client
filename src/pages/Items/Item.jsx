          ...
          >
            <div className='flex justify-between items-center'>
              ...
              <div className='flex items-center gap-2'>
                ...
                {itemData.length > 0 && <div className='flex justify-end'>
                      ...
                      itemData.map((data, i) => {
                        ...
                        return <tr key={i} onClick={() => navigate("/admin/item/details/" + data._id)} className='cursor-pointer hover:bg-gray-100'>
                          <td className='py-2 px-4 border-b max-w-[10px]'>
                            <input type='checkbox' checked={selected.includes(data._id)}
                              onChange={(e) => {
                          ...
                          <td className='px-4 border-b'>
                            ...
                            {
                              data.category && (
                                <p className="text-[10px] bg-gray-100 rounded w-fit px-[2px] border mb-[2p]">
                                  {data.category?.title}
                                </p>
                              )
                            }
